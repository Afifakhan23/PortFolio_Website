...
const Navbar = () => {
    return (
        <div className='z-50 sticky top-0'>
            <header className="text-gray-400 bg-gray-900 body-font shadow-md shadow-slate-500">
                <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    ...
                    <a href="/public/assets/cv/My CV.pdf">
                        <button className="inline-flex items-center bg-gray-700 border-0 py-1 px-3 focus:outline-none hover:bg-purple-500 hover:text-white rounded text-base mt-4 md:mt-0">Download CV
